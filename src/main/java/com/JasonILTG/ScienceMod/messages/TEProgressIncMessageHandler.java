...
/**
 * Message handler for TEProgressMessages.
 * 
 * @author JasonILTG and syy1125
 */
public class TEProgressIncMessageHandler implements IMessageHandler<TEProgressIncMessage, IMessage>
{
    @Override
    public IMessage onMessage(final TEProgressIncMessage message, MessageContext ctx)
    {
     ...
     */
    void processMessage(WorldClient worldClient, TEProgressIncMessage message)
    {
        ...
        te.setProgressInc(message.getProgressInc());
    }
}