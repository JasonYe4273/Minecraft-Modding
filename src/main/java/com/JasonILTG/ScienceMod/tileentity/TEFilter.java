...
public class TEFilter extends TEMachine //FRAMEWORK; NOT DONE
{
	public static final String NAME = "Filter";
	
	private static final int JAR_INV_SIZE = 1;
	private static final int INPUT_INV_SIZE = 1;
	private static final int OUTPUT_INV_SIZE = 2;
	...
	{
		return FilterRecipe.values();
	}
	
	@Override
	protected void consumeInputs(MachineRecipe recipe)
	{
		if (!(recipe instanceof FilterRecipe)) return;
		FilterRecipe validRecipe = (FilterRecipe) recipe;
	...
	public enum FilterRecipe implements MachineRecipe
	{
		Solution(DEFAULT_MAX_PROGRESS, 1, new ItemStack(ScienceModItems.solution), new ItemStack[]{ new ItemStack(ScienceModItems.solution), new ItemStack(ScienceModItems.mixture) });
		...
		private FilterRecipe(int requiredTime, int requiredJarCount, ItemStack requiredItemStack, 
