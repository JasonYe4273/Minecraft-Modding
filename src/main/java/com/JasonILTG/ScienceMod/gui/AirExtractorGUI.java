...
public class AirExtractorGUI extends InventoryGUI
{
	...
	public void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY)
	{
		...
		TEMachine te = (TEMachine) container.getTE();
		if (te != null)
		{
			drawPartial(Textures.GUI.PROGRESS_BAR_FULL, guiLeft + Textures.GUI.AIR_EXTRACTOR_PROGRESS_X, guiTop + Textures.GUI.AIR_EXTRACTOR_PROGRESS_Y,
