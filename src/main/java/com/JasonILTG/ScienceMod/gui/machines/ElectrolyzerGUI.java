...
public class ElectrolyzerGUI extends MachineGUI
{
	...
	{
		super(new ElectrolyzerGUIContainer(playerInv, te), playerInv, te, Textures.GUI.Machine.ELECTROLYZER, Textures.GUI.Machine.ELECTROLYZER_GUI_WIDTH, Textures.GUI.Machine.ELECTROLYZER_GUI_HEIGHT,
