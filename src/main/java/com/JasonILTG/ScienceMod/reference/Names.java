...
public class Names
{
	public static final class Items
	{
		...
		public static final String[] ELEMENT_SUBTYPES = { "hydrogen", "helium", "lithium", "beryllium", "boron", "carbon", "nitrogen",
				...
				"cerium", "praseodymium", "neodymium", "prometheum", "samarium", "europium", "gadolinium", "terbium", "dysprosium",
		...
		public static final String[] ELEMENT_SYMBOLS = { "H", "He", "Li", "Be", "B", "C", "N", "O", "F", "Ne", "Na", "Mg", "Al", "Si",
