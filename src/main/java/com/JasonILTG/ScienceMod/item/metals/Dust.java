...
/**
 * <code>Item</code> class for <code>Dust</code>s.
 * 
...
public class Dust extends ItemScience
{
	...
	{
		return String.format("item.%s%s.%s", Reference.RESOURCE_PREFIX, "dust", EnumDust.VALUES[stack.getMetadata()].name.toLowerCase());
	}
	...
	{
		for (int meta = 0; meta < EnumDust.VALUES.length; meta++)
		{
