...
public class NumbersReference
{
	...
	public static final String CLIENT_PROXY_CLASS = "com.JasonILTG.NumbersMod.proxy.NumbersClientProxy";
	public static final String SERVER_PROXY_CLASS = "com.JasonILTG.NumbersMod.proxy.NumbersCommonProxy";
